...
```json
{
  ...
  "target_ticket_no": "钉钉消息测试-收银机-1天-003",
  ...
  "missing_fields": [],
  "candidate_scores": [
    {"ticket_no": "钉钉消息测试-收银机-1天-003", "score": 0.95},
    {"ticket_no": "钉钉消息测试-打印机-3天-006", "score": 0.42}
  ],
...
```text
1. 新建一张工单
2. 补充到 钉钉消息测试-房门-3天-002
3. 补充到 钉钉消息测试-门锁-1天-005
```
